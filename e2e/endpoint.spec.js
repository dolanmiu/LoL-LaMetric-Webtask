...
async function test() {
  ...
  response = await getEndPoint(
    `https://euw1.api.riotgames.com/lol/match/v4/matchlists/by-account/qIvfAC3kJDBNSpAFxLOgtp7EmyyLeBSju6eEeL4licXUeA?api_key=${apiKey}`,
  );
  expect(response)
  ...
  response = await getEndPoint(
    `https://euw1.api.riotgames.com/lol/league/v4/positions/by-summoner/pgF2b5z51x3sEPpbVUU1xxWb2ZeQKPwNg1_viU0LtJUJ03s?api_key=${apiKey}`,
  );
